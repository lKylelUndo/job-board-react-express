  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 p-5 shadow-sm">
      ...
      <ul className="space-y-4">
        ...
        <li><Link to="/employers" className="text-gray-700 hover:text-blue-500">Employers</Link></li>
        <li><Link to="/candidates" className="text-gray-700 hover:text-blue-500">Candidates</Link></li>
        <li><Link to="/applications" className="text-gray-700 hover:text-blue-500">Applications</Link></li>
